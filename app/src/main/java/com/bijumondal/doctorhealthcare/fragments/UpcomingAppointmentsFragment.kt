...
import kotlinx.android.synthetic.main.fragment_upcoming_appointments.*
...
class UpcomingAppointmentsFragment : Fragment() {
    ...
    companion object {
        fun newInstance(): UpcomingAppointmentsFragment = UpcomingAppointmentsFragment()
        private const val TAG: String = "UpcomingAppointmentsFragment"
    }
    ...
    override fun onCreateView(
        ...
        appointmentsListRecyclerView = view.findViewById(R.id.rv_upcoming_appointments_list)

        if (mPreference.getUserType() == 1) {

            layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
            appointmentsListRecyclerView.layoutManager = layoutManager
            val request1 = RequestAppointmentListForPatient(mPreference.getUserId().toString(), 1)
            ...
            layoutManager = LinearLayoutManager(context, LinearLayoutManager.VERTICAL, false)
            appointmentsListRecyclerView.layoutManager = layoutManager
            val request = RequestAppointmentsListForDoctor(mPreference.getUserId().toString(), 1)
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (response.body()!!.success) {
                            ...
                            if (mData != null && !mData.isEmpty()) {
                                ...
                                tv_no_upcoming_appointments_found.visibility = View.GONE

                            } else {
                                appointmentsListRecyclerView.visibility = View.GONE
                                tv_no_upcoming_appointments_found.visibility = View.VISIBLE
                            }
